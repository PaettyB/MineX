...
public class GUIText {
	...
	public GUIText(String text, float fontSize, FontType font, Vector2i position, int maxLineLength,
			boolean centered) {
		this.textString = text;
		this.fontSize = fontSize;
		this.font = font;
	...
	public void update(String text) {
		textString = text;
		TextMaster.updateText(this, textMeshVao, posVBO, texVBO);
	}
	
	public void append(String appendix){
		String newText = textString.concat(appendix);
		update(newText);
	}
	...
	public void setPosition(Vector2i pos) {
		position = Utils.toNormalPosition(pos);
	}
	 ...
	 */
	public void setMeshInfo(int vao, int posVBO, int texVBO,int verticesCount) {
