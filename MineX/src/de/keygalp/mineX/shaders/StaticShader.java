...
public class StaticShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = Game.SRC + "shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = Game.SRC + "shaders/fragmentShader.txt";
